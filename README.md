...
### Figure 16 — Celebrity AE Model Performance on Forget Set
...
### Figure 17 — Celebrity AE Model Performance on Retain Set
![Celebrity Face Model Performance on Retain Set](blog_figures/AE_Before_Retain.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C16).

### Figure 18 — Celebrity Gradient Ascent on Forget Set
![Celebrity Gradient Ascent on Forget Set](blog_figures/AE_GA_Forget.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C23).

### Figure 19 — Celebrity Gradient Ascent on Retain Set
![Celebrity Gradient Ascent on Retain Set](blog_figures/AE_GA_Retain.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C24).

### Figure 20 — Celebrity Random Noise Targeting on Forget Set
![Celebrity Random Noise Targeting on Forget Set](blog_figures/AE_RN_Forget.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C30).

### Figure 21 — Celebrity Random Noise Targeting on Retain Set
![Celebrity Random Noise Targeting on Retain Set](blog_figures/AE_RN_Retain.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C29).

### Figure 22 — Celebrity Bad Teacher
![Celebrity Bad Teacher](blog_figures/AE_Teacher.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C33).

### Figure 23 — Celebrity Good / Bad Teacher Targeting on Forget Set
![Celebrity Good / Bad Teacher on Forget Set](blog_figures/AE_Teacher_Forget.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C38).

### Figure 24 — Celebrity Random Noise Targeting on Retain Set
![Celebrity Good / Bad Teacher on Retain Set](blog_figures/AE_Teacher_Retain.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C37).

### Figure 25 — Celebrity Unlearning Comparisons on Forget Set
![Celebrity Unlearning Comparisons on Forget Set](blog_figures/AE_Unlearning_Comparison_F.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C40).

### Figure 26 — Celebrity Unlearning Comparisons on Retain Set
![Celebrity Unlearning Comparisons on Forget Set](blog_figures/AE_Unlearning_Comparison_R.png)
Generated in [celeb_unlearning.ipynb](https://vscode.dev/github/RexTabachnick/Machine-Unlearning-In-Applied-Contexts/blob/main/celeb_unlearning.ipynb#C41).